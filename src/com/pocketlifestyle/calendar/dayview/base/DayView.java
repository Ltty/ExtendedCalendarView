...
import com.pocketlifestyle.calendar.dayview.base.DayViewScrollingController.HorizontalScrollDirection;
import com.pocketlifestyle.calendar.dayview.base.DayViewScrollingController.HorizontalScrollingStartedEvent;
import com.pocketlifestyle.calendar.dayview.base.DayViewScrollingController.ScrollEvent;
import com.pocketlifestyle.calendar.dayview.base.DayViewScrollingController.VerticalScrollingStartedEvent;
import com.pocketlifestyle.calendar.dayview.base.events.CreateEventEvent;
import com.pocketlifestyle.calendar.dayview.base.events.EventSelectionListener;
import com.pocketlifestyle.calendar.dayview.base.events.ShowDateInCurrentViewEvent;
...
{
	private EventSelectionListener mEvSelListener = null;
    ...
    public void setEventSelectionListener(EventSelectionListener _listener)
    {
    	mEvSelListener = _listener;
    }
...
//        drawSelectedRect(r, canvas, p);
    ...
    void setSelectedEvent(EventLayout e) {
        ...
        if(null!=e)
        {
        Log.e("Peter", "event selected:"+e.getEvent().toString());
        mEvSelListener.notifyEventSelected(e.getEvent());
